...
const fields = [
  ...
  {name:"category", label:"Project Type", type: "select",options:["Civil","Electro",] , rules: { required: "category is required" } },
  {name:"date", label:"Complete On",type:"date",rules: { required: "Date is required",...DateValidationCheck }},
  {name:"feature", label:"Is feature",type:"checkbox",rules: { required: "Date is required" }},
